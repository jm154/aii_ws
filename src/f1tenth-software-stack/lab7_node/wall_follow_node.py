...
class WallFollow(Node):
    ...
    def __init__(self):
        ...
        self.sub_safety_drive = self.create_subscription(AckermannDriveStamped, safety_topic, self.safety_callback, 10) ### for AEB
    ...
    def safety_callback(self, drive_msg):
        if drive_msg.drive.speed == 0:
            self.safe_alarm = True
